...
module ASSIGNMENT
    ...
    syntax IExp ::= "[]"
    rule <k> I1 * I2 => I1 ~> [] * I2 ... </k> requires notBool isKResult(I1)
    rule <k> I1 * I2 => I2 ~> I1 * [] ... </k> requires notBool isKResult(I2)

    rule <k> I1 ~> [] * I2 => I1 * I2 ... </k> requires isKResult(I1)
    rule <k> I2 ~> I1 * [] => I1 * I2 ... </k> requires isKResult(I2)
